// Language data for all articles
const articles = {
    "snitching": {
        title: "Snitching",
    ...
    "back-to-the-future": {
        ...
        artist: "A$AP Rocky",
        content: {
            en: "A song that was made during the 'Mouth Fulla Gold' sessions. The track was likely made in the same sessions as 'Purple Swag' and 'Peso'. Released online on September 19th, 2011 as a tribute to the famous Nike MAG shoes that were released on September 8th, 2011. These shoes were made in reference to the 1989 film 'Back to the Future Part II' as the shoes are a replica of the self-tying shoes in that movie. The song's title and hook reference the 'Back to the Future' film franchise saying 'Back to the future, that Marty McFly', who is one of the main characters in the film series.",
            es: "Una canción que se hizo durante las sesiones de 'Mouth Fulla Gold'. La canción fue hecha probablemente en las mismas sesiones que 'Purple Swag' y 'Peso'. Lanzada en línea el 19 de septiembre de 2011 como homenaje a las famosas zapatillas Nike MAG lanzadas el 8 de septiembre de 2011. Dichas zapatillas se hicieron en referencia a la película de 1989 'Regreso al Futuro Parte II'. El título y el gancho hacen referencia a la franquicia 'Regreso al futuro' diciendo 'Back to the future, that Marty McFly', uno de los personajes principales de la serie.",
    ...
    "need-to-feel-loved": {
        ...
        content: {
            en: "Adam K & Soha's 'Need To Feel Loved' (Vocal Mix) masterfully blends emotional depth with progressive house beats, creating a track that resonates with the heart and the dance floor alike. OK, so this intro description was AI generated. This song is extremely good. It is simple, but not simple, after listening to it, you will know what I mean. The song samples 'Ghosts', part of the soundtrack to the 2002 film Road to Perdition. Imagine listening to this song while sitting in some pub with ocean view. Shisha type bar with drinks. 2/3 a.m. in the morning, naaah that's something else.",
            es: "'Need To Feel Loved' (Vocal Mix) de Adam K & Soha combina magistralmente la profundidad emocional con ritmos house progresivos. OK, la descripción era AI. Esta canción es extremadamente buena. Es sencilla, pero no simple, después de escucharla, sabrás lo que quiero decir. La canción samplea 'Ghosts', parte de la banda sonora de la película de 2002 Road to Perdition. Imagínate escuchar esta canción mientras estás sentado en un pub con vistas al mar. Un bar tipo shisha con bebidas. 2/3 de la mañana, naaah eso es otra cosa.",
            pl: "'Need To Feel Loved' (Vocal Mix) Adama K & Soha łączy mistrzowsko głębię emocjonalną z progresywnymi rytmami house. OK, koniec tego pieprzenia AI-owego. Zajebista nuta, sampel 'Ghosts' użyty w filmie z T. Hanks'em 'Road to Perdition'. Wyobraź sobie słuchanie tej nutki siedząc w jakimś pubie z widokiem na ocean. Shisha bar, driny o 2/3 w nocy, this hits different."
        },
        date: "2025-03-07",
...
function getContent(article, field) {
    if (typeof article[field] === 'object') {
        return article[field][currentLanguage] || article[field]['en'];
    }
